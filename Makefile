...
CFLAGS        = -pipe -O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector --param=ssp-buffer-size=4 -Wformat -Wformat-security -fmessage-length=0 -march=armv7-a -mfloat-abi=hard -mfpu=neon -mthumb -Wno-psabi -fPIC -fvisibility=hidden -fvisibility-inlines-hidden -Wall -W -D_REENTRANT -fPIE $(DEFINES)
CXXFLAGS      = -pipe -O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector --param=ssp-buffer-size=4 -Wformat -Wformat-security -fmessage-length=0 -march=armv7-a -mfloat-abi=hard -mfpu=neon -mthumb -Wno-psabi -fPIC -fvisibility=hidden -fvisibility-inlines-hidden -Wall -W -D_REENTRANT -fPIE $(DEFINES)
INCPATH       = -I/usr/share/qt5/mkspecs/linux-g++ -I. -I/usr/include/sailfishapp -I/usr/include/mdeclarativecache5 -I/usr/include/qt5 -I/usr/include/qt5/QtQuick -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtQml -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtCore -I.
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/usr/share/harbour-upanddown/lib
LIBS          = $(SUBLIBS) -pie -rdynamic -L/usr/lib/ -lsailfishapp -lmdeclarativecache5 -lQt5Quick -lQt5Gui -lQt5Qml -lQt5Network -lQt5Core -lGLESv2 -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = src/harbour-upanddown.cpp 
OBJECTS       = harbour-upanddown.o
DIST          = /usr/share/qt5/mkspecs/features/spec_pre.prf \
		...
		harbour-upanddown.pro \
		harbour-upanddown.pro
QMAKE_TARGET  = harbour-upanddown
...
Makefile: harbour-upanddown.pro /usr/share/qt5/mkspecs/linux-g++/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/harbour-upanddown1.0.0 || mkdir -p .tmp/harbour-upanddown1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/harbour-upanddown1.0.0/ && $(COPY_FILE) --parents src/harbour-upanddown.cpp .tmp/harbour-upanddown1.0.0/ && $(COPY_FILE) --parents translations/upanddown-de.ts .tmp/harbour-upanddown1.0.0/ && (cd `dirname .tmp/harbour-upanddown1.0.0` && $(TAR) harbour-upanddown1.0.0.tar harbour-upanddown1.0.0 && $(COMPRESS) harbour-upanddown1.0.0.tar) && $(MOVE) `dirname .tmp/harbour-upanddown1.0.0`/harbour-upanddown1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/harbour-upanddown1.0.0
...
harbour-upanddown.o: src/harbour-upanddown.cpp /usr/include/qt5/QtQuick/QtQuick \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o harbour-upanddown.o src/harbour-upanddown.cpp

####### Install

install_qm: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/harbour-upanddown/translations || mkdir -p $(INSTALL_ROOT)/usr/share/harbour-upanddown/translations
	lupdate -noobsolete "/home/mersdk/share/ownCloud/programming/upANDdown/src" "/home/mersdk/share/ownCloud/programming/upANDdown/qml" -ts "/home/mersdk/share/ownCloud/programming/upANDdown/translations/harbour-upanddown.ts" "/home/mersdk/share/ownCloud/programming/upANDdown/translations/upanddown-de.ts" && mkdir -p translations && [ "/home/mersdk/share/ownCloud/programming/upANDdown" != "/home/mersdk/share/ownCloud/programming/upANDdown" -a 1 -eq 1 ] && cp -af "/home/mersdk/share/ownCloud/programming/upANDdown/translations/upanddown-de.ts" "/home/mersdk/share/ownCloud/programming/upANDdown/translations" || : ; [ 1 -eq 1 ] && lrelease -nounfinished "/home/mersdk/share/ownCloud/programming/upANDdown/translations/upanddown-de.ts" || :
	-$(INSTALL_FILE) /home/mersdk/share/ownCloud/programming/upANDdown/translations/upanddown-de.qm $(INSTALL_ROOT)/usr/share/harbour-upanddown/translations/

uninstall_qm: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/harbour-upanddown/translations/upanddown-de.qm
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/harbour-upanddown/translations/ 


install_qml: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/harbour-upanddown || mkdir -p $(INSTALL_ROOT)/usr/share/harbour-upanddown
	-$(INSTALL_DIR) /home/mersdk/share/ownCloud/programming/upANDdown/qml $(INSTALL_ROOT)/usr/share/harbour-upanddown/

uninstall_qml: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/harbour-upanddown/qml
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/harbour-upanddown/ 
...
install_desktop: first FORCE
	...
	-$(INSTALL_FILE) /home/mersdk/share/ownCloud/programming/upANDdown/harbour-upanddown.desktop $(INSTALL_ROOT)/usr/share/applications/

uninstall_desktop: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/harbour-upanddown.desktop
...
install_icon: first FORCE
	...
	-$(INSTALL_FILE) /home/mersdk/share/ownCloud/programming/upANDdown/harbour-upanddown.png $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/

uninstall_icon: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/harbour-upanddown.png
